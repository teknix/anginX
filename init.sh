...
echo ""
echo "  curl (LAN host — service running on a different machine):"
...
echo -e "    ${CYAN}req = urllib.request.Request(${NC}"
echo -e "    ${CYAN}    'http://YOUR_SERVER_IP/new/${ANGINX_API_KEY}',${NC}"
echo -e "    ${CYAN}    data=json.dumps({${NC}"
echo -e "    ${CYAN}        'domain': 'app.yourdomain.com',${NC}"
echo -e "    ${CYAN}        'port':   7705,${NC}"
echo -e "    ${CYAN}        'name':   'myapp',${NC}"
echo -e "    ${CYAN}        'host':   '192.168.1.50',  # omit if Docker same-network${NC}"
echo -e "    ${CYAN}    }).encode(),${NC}"
echo -e "    ${CYAN}    headers={'Content-Type': 'application/json'},${NC}"
echo -e "    ${CYAN})${NC}"
echo -e "    ${CYAN}urllib.request.urlopen(req)${NC}"
echo ""
echo "  ─────────────────────────────────────────────────"
